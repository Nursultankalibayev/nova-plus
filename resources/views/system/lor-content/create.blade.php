...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Манипуляция | Добавление</h4> </div>
            ...
            <div class="panel panel-default">
                <div class="panel-wrapper p-b-10 collapse in">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form action="{{route('lor-content.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="price_ru" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Цена KK</label>
                                        <div class="col-md-12">
                                            <input type="text" name="price_kk" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Цена EN</label>
                                        <div class="col-md-12">
                                            <input type="text" name="price_en" class="form-control" value="">
                                        </div>
                                    </div>
