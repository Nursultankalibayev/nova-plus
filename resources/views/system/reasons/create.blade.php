...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Распространённые причины вызова | Добавление</h4> </div>
            ...
            <div class="panel panel-default">
                <div class="panel-wrapper p-b-10 collapse in">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form action="{{route('reasons.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="form-control" name="desc_ru" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Описание KK</label>
                                        <div class="col-md-12">
                                            <textarea class="form-control" name="desc_kk" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
