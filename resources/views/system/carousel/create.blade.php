...
@section('content')
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Слайдер | Добавление</h4> </div>
            ...
            <div class="panel panel-default">
                <div class="panel-wrapper p-b-10 collapse in">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form action="{{route('carousel.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="short_desc_ru" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Краткое описание KK</label>
                                        <div class="col-md-12">
                                            <input type="text" name="short_desc_kk" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Краткое описание EN</label>
                                        <div class="col-md-12">
                                            <input type="text" name="short_desc_en" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Название кнопки RU *</label>
                                        <div class="col-md-12">
                                            <input type="text" name="title_button_ru" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Название кнопки KK</label>
                                        <div class="col-md-12">
                                            <input type="text" name="title_button_kk" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Название кнопки EN</label>
                                        <div class="col-md-12">
                                            <input type="text" name="title_button_en" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="sorting" class="form-control" value="1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select id="type" class="form-control" name="type">
                                                <option value="0">Вызов</option>
                                                <option value="1">Переход</option>
                                            </select>
                                        </div>
                                    </div>
